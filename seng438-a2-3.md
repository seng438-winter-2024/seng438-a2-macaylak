...
- Data is null
- Data empty
- If data object is not type Values2D
...
**Invalid:**
- Negative index 
- Out of bounds index (greater than size)
...
- Data is null 
- Empty double array
- Array is not comprised of only double primitives

**Valid:** 
- Array of positive doubles
- Array of negative doubles
- Array of mixed doubles

### min/max

**Invalid:**
- Array contains values above: 1.79769313486231570e+308d
- Array contains values below: 2.2250738585072014E-308

**Valid:**
- Double value is between .79769313486231570e+308d and 2.2250738585072014E-308.
...
**Invalid**
- Data is null
- Data object is not type KeyedValues

**Valid**
- keyValues = keys: [0,1,2] values:[5,9,2]
- Single data point.
- Two data points.
- Three or more data points.
- Data points with zero values.
- Data points with non-zero values
...
- Negative boundary
- Boundary = 0
- Boundary is positive infinity
- Boundary is negative infinity
...
**Boundary:**
- Between equal integers (length = 0)
- Between two negative numbers
- Between two positive numbers 
- From a specific number to positive infinity 
- From a specific number to negative infinity
...
**Valid:**
- Object of the same type as Range.

**Comparison with Different Range**
- Range with different values.

**Valid:**
- Range with the same values.
...
**Valid:**
- Non-null range with valid lower and upper margins.
...
**Invalid:**
- Both lower and upper margins are zero.
